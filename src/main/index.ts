...
app.whenReady().then(() => {
  ...
  // bookmark operations
  ipcMain.handle('add-bookmark', (event, title: string, url: string) => {
    try {
  ...
  ipcMain.handle('delete-bookmark', (event, id: number) => {
    try {
  ...
  // history operations
  ipcMain.handle('add-history', (event, title: string, url: string) => {
    try {
